...
def registrar_usuario():
    ...
    registrar_dados_usuario(nome, email,senha, confirmar_senha,mostrar_inicial)
...
def logar_usuario():
    ...
    verificar_senha(email, senha, mostrar_principal)
...
botao_registro_voltar = CTkButton(frame_registro,
        text="VOLTAR", command=mostrar_inicial)
...
botao_login_voltar = CTkButton(frame_login,
    text="VOLTAR", command=lambda:[mostrar_inicial(),
    entrada_login_nome.delete(0, "end"),
    entrada_login_email.delete(0, "end"),
    entrada_login_senha.delete(0, "end")])
...
botao_principal_formulario = CTkButton(frame_principal,
        text="FORMULARIO", command=mostrar_formulario)
...
botao_formulario_voltar = CTkButton(frame_formulario,
        text="VOLTAR", command=mostrar_principal)
